...
//
//public class DijkstraMultiplePairsResult {
//
//    private final List<DijkstraResult> results;
//    private final Runnable closeStreamAction;
//
//    private final AtomicBoolean consumptionTriggered;
//
//    public DijkstraMultiplePairsResult(List<DijkstraResult> results) {
//        this(results, () -> {});
//    }
//
//    public DijkstraMultiplePairsResult(List<DijkstraResult> results, Runnable closeStreamAction) {
