...
public abstract class DijkstraMultiplePairsMutateProc<ALGO extends Algorithm<DijkstraResult>, CONFIG extends AlgoBaseConfig & MutateRelationshipConfig> extends MutateProc<ALGO, DijkstraResult, MutateResult, CONFIG> {
